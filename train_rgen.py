...
# Note: label indexing is not done properly

# This is an extension where the task loss is backpropagated to the generators
# E.g. a2b task loss is back propagated to a2b_gen, a2b2a task loss is back propagated to both a2b_gen and b2a_gen
...
LOG_DIR = "log/a2b2a_rgen_LAMBDA10000/"
...
g_loss_sum = g_loss_a2b + g_loss_b2a + g_loss_cyc_a + g_loss_cyc_b + LAMBDA_RGEN * (r_loss_a2b + r_loss_a2b2a)
